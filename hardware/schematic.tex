% ESP8266 (NodeMCU V3 / LoLin) Relay & Sensor Controller -- schematic, Rev B
...
%======================================================================
\draw[mod, fill=blue!4] (0,2.2) rectangle (5,16.2);
...
\draw[mod, fill=gray!20] (1.3,0.4) rectangle (3.7,1.5);
\node[title] at (2.5,0.95) {J1 \; micro-USB};
\draw[p5] (2.5,1.5) -- (2.5,2.2);
\node[pin, anchor=west] at (2.6,1.85) {5 V};

%======================================================================
% POWER RAILS
%======================================================================
% +5V: VIN -> right breadboard + rail
\draw[p5] (-0.6,2.8) -- (-6,2.8) -- (-6,20) -- (19,20) -- (19,14.2);
...
\draw[p3] (5.6,10) -- (18,10) node[circ]{};
\draw[p3] (18,11.9) -- (18,7.1);
\node[title, rail3, anchor=west, align=left] at (18.2,9) {+3V3 RAIL\\(breadboard left +)};

% Common GND bus
\draw[pg] (5.6,3.6) -- (6.2,3.6) -- (6.2,-0.5) node[circ]{};
\draw[pg] (-6,-0.5) -- (21,-0.5);
\draw[pg] (8,-0.5) node[circ]{} -- (8,-0.8) node[ground]{};
\node[title, railg, anchor=north west] at (8.4,-0.6)
...
% LEGEND / TITLE BLOCK
%======================================================================
\draw[thick] (-7,-2) rectangle (22.4,-4.0);
\node[note, anchor=north west] at (-6.8,-2.15) {%
  \textbf{ESP8266 Relay \& Sensor Controller} \quad Rev B \quad (U1 = NodeMCU V3 / LoLin, all 30 header pins shown)\\[2pt]
  ...
  Dot = junction; crossing without dot = no connection. All G pins are common internally; all 3V pins are common internally.\\

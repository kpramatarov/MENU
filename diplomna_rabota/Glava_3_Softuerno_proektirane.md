...
библиотеката `EEPROM` емулира такава чрез отделен сектор от SPI Flash паметта, който се
...
| 79…84 | 6 B | `peerMac[6]` | MAC адрес на отсрещния възел |
...
радиостека**. Затова в тях е недопустимо да се извършват продължителни операции, работа
...
Статичното съдържание на потребителския интерфейс се съхранява в **LittleFS** – файлова
...
Използването на **Fetch API** с `async/await` осигурява **асинхронно обновяване без
...
Библиотеката `DallasTemperature` по подразбиране изчаква завършването на преобразуването
...
## Използвани източници към Глава 3

23. Espressif Systems. *ESP8266 Non-OS SDK API Reference.* Version 3.0.
24. ESP8266 Community. *Arduino core for ESP8266 – Documentation: Filesystem (LittleFS),
    EEPROM, ESP8266WebServer.*
25. ARM Ltd. *littlefs – A little fail-safe filesystem designed for microcontrollers.*
26. Burton, M. *Arduino-Temperature-Control-Library (DallasTemperature) – Documentation.*

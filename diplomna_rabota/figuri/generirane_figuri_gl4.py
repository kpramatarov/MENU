...
def fig_4_1():
    ...
    s += box(20, 18, 740, 64, 'Въздействия („потребители“)',
             ['браузър (/data всяка секунда, команди), тест PING, бутони с трептене,',
              'намокряне на HR202, грешки на DHT11, рестарти, прекъсвания на връзката'], '#f4f4f4', fs=11.5)
    # двата възела
    s += box(20, 130, 300, 150, 'Подчинен възел',
             ['Slave.ino – без промени', 'имитация: DHT11, HR202, бутони,', 'релета, АЦП, EEPROM, UART,',
    ...
    s += box(20, 470, 440, 96, 'Проверки по време на симулацията',
             ['защита при влага, съгласуваност на състоянието,', 'отчитане на загубите, напредък на опашката,',

...
![Фиг. 4.1](figuri/png/fig_4_1_postanovka.png){width=16cm}
...
| 8 | Експериментално изследване | Методика с вградени средства за измерване; очаквани стойности и критерии по опити Е1–Е12 | 4.1–4.7 |
...
**Комуникационна подсистема.** Изчисленото време до потвърждението по ESP-NOW при
1 Mbit/s е 1,1…1,7 ms, а двупосочното закъснение „команда – отчет" – **2,8…4,0 ms**. При
съвпадение с четенето на DHT11 (около 1,25 % от заявките) то нараства до около 29 ms.
Енергийният бюджет дава допустимо затихване 108 dB – на 20 m в жилищна сграда остават около
31 dB за загуби в прегради. Тези оценки се проверяват с опитите от Глава 4.
...
LittleFS [41], и извеждането им като графики. Така устройството се превръща от

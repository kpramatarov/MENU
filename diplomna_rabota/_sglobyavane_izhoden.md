...
| &nbsp;&nbsp;&nbsp;&nbsp;4.3. Изследване на закъснението | 61 |
| &nbsp;&nbsp;&nbsp;&nbsp;4.4. Изследване на точността на температурното измерване | 63 |
| &nbsp;&nbsp;&nbsp;&nbsp;4.5. Експериментална проверка на филтъра за потискане на трептенето | 64 |
| &nbsp;&nbsp;&nbsp;&nbsp;4.6. Изследване на времето за цикъл | 65 |
| &nbsp;&nbsp;&nbsp;&nbsp;4.7. Изследване на надеждността при продължителна работа | 66 |
...
8. **Експериментално изследване** – закъснение и надеждност на връзката, време за цикъл на
   програмата, точност на измерването на напрежението и действие на защитите и на органите
...
UART, обмена по ESP-NOW, уеб сървъра и организацията на неблокиращия главен цикъл. **Глава 4** представя експерименталните
...
За закрити помещения се прилага логаритмичният модел [38, 39]:
...
Броячите `successPackets` и `failedPackets` са вградени в телеметрията (Таблица 3.4), което
...
**Стандартната неопределеност по тип Б** се извежда от каталожната граница ±0,5 °C [40] при
приемане на равномерно разпределение:

$$u_B = \frac{0{,}5}{\sqrt{3}} = 0{,}289\ ^\circ\text{C}$$

Съгласно [41] **комбинираната** и **разширената** неопределеност при коефициент на покритие $k = 2$
...
Времето за един цикъл се измерва **вградено** – чрез величината `loopMaxUs`
(т. 3.5.2), която се включва в телеметрията. Измерването се провежда в четири режима,

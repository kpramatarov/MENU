...
**Обосновка на избора на транзистор.** Транзисторът 2N2222 е избран поради следните
...
**Обосновка на избора на датчик.** DS18B20 е предпочетен пред аналогови датчици (LM35,
...
- **по ток** – максималният изходен ток на един извод е **12 mA**, докато бобината
  изисква над 70 mA;
...
**Проверка на параметрите на диода:**
...
линеен стабилизатор AMS1117-3.3.
...
функции при стартиране** (*boot straps*), чието нарушаване прави зареждането невъзможно.
...
## Използвани източници към Глава 2

18. Espressif Systems. *ESP8266 Hardware Design Guidelines.* Version 2.6, 2023.
19. onsemi. *P2N2222A / 2N2222A – Amplifier Transistors NPN Silicon – Datasheet.*
20. Vishay. *1N4001 – 1N4007 General Purpose Plastic Rectifier – Datasheet.*
21. Analog Devices (Maxim Integrated). *DS18B20 Programmable Resolution 1-Wire Digital

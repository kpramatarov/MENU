...
cell(ws, "G7", "R горен (VIN → A0), kΩ", "label"); ws.merge_cells("G7:I7"); cell(ws, "J7", 47, "in", "0.00")
cell(ws, "G8", "R долен (A0 → GND), kΩ", "label"); ws.merge_cells("G8:I8"); cell(ws, "J8", 20, "in", "0.00")
note(ws, "J7", "Номинална стойност по данни на дипломанта (R1 = 47 kΩ). Ако резисторите се измерят с омметър, заменете с измереното.")
note(ws, "J8", "Номинална стойност по данни на дипломанта (R2 = 20 kΩ). Ако резисторите се измерят с омметър, заменете с измереното.")
...
cell(ws, "A5", "Захранване на модула HR202, V (3,3 или 5?)", "label"); ws.merge_cells("A5:D5"); cell(ws, "E5", 3.3, "in", "0.00")
note(ws, "E5", "Номинално: модулът се захранва от извода 3V3 на NodeMCU (по данни на дипломанта). Измерената стойност може да се впише тук.")
